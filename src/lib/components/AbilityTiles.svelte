<script lang="ts">
	/**
	 * A unit's abilities as a command card: square tiles, the in-game button
	 * art, the tooltip on hover or focus. Shared by the class pages (a class's
	 * standard abilities) and the entity pages (what a unit's card carries).
	 * `dense` is the rail's size; the default is the main column's, where the
	 * tiles have room.
	 */
